...
def run():
    try:
        ...
        my_car.config_steering(_STEERING_PIN, 86, 140, 38)
        ...
        suspension_cfg = [('fl', _FL_SERVO_PIN, 133, 133, 68),
                          ('fr', _FR_SERVO_PIN, 43, 43, 108),
                          ('rl', _RL_SERVO_PIN, 50, 50, 125),
                          ('rr', _RR_SERVO_PIN, 125, 125, 50)]
