...
class ServoCorner:
    def __init__(self, servo_pin, top_limit = 80, bottom_limit= 100, speed_ms = 750):
        self.servo = Servo(servo_pin, frequency=100, speed_ms=speed_ms, control_loop_interval_ms=5)
